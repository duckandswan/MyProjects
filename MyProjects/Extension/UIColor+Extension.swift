...
extension UIColor {
    ...
    static var findingBGColor : UIColor {
        return UIColor(rgb: 0xECECEC)
    }
    
    static var findingRed : UIColor {
        return UIColor(rgb: 0xE85332)
    }
    
    static var findingBlack : UIColor {
        return UIColor(rgb: 0x333333)
    }
    
    static var findingDarkGray : UIColor {
        return UIColor(rgb: 0x666666)
    }
    
    static var findingGray : UIColor {
        return UIColor(rgb: 0x999999)
    }
    
    static var findingViewBg_LightGray : UIColor {
